...
// zara add this
// import "circular-std";
//  document.body.style.fontFamily ='circular-std';
 // zara add above
...
// stickyheader
// zara
// initStricky: function initStricky () {
//     if ($('.stricky').length) {
...
//         var strickyScrollPos = 100;
//         if($(window).scrollTop() > strickyScrollPos) {
//             $('.nav-wrapper').removeClass('fadeIn animated');
//             $('.nav-wrapper').addClass('nav-wrapper.stricky-fixed fadeInDown animated');
//             $('.scroll-to-top').fadeIn(500);
//         }
//         else if($(this).scrollTop() <= strickyScrollPos) {
//             $('.nav-wrapper').removeClass('nav-wrapper.stricky-fixed fadeInDown animated');
//             $('.nav-wrapper').addClass('slideIn animated');
//             $('.scroll-to-top').fadeOut(500);
//         }
//     };
// }
